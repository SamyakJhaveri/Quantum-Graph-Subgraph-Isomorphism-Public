...
def create_dqm_helper_function(G1, G2):
    ...
    if n1 < n2:
        raise ValueError("Custom message in 'create_dqm_helper_function()': n1 must be greater than or equal to n2.")
    ...
    for node2 in G2.nodes:
        ...
        for node1 in G1.nodes:
            ...
            if node1_type == node2_type:
                #print("node1 ({}) and node2 ({}) have the same type".format(node1, node2))
                continue
...
if __name__ == "__main__":
    ...
    with open('/home/samyaknj/Research/UCI Quantum Code Clone Detection Project/Dataset/sample4/sample4_type1_v1.py', 'r') as f1,\
        open('/home/samyaknj/Research/UCI Quantum Code Clone Detection Project/Dataset/sample4/sample4_type3_v2.py', 'r') as f2:
        code1 = f1.read()
        code2 = f2.read()
    
    
    NXGraph_G1 = code_to_networkx_script_for_experiment.parse_ast_to_networkx_graph(ast.parse(code1))
    NXGraph_G2 = code_to_networkx_script_for_experiment.parse_ast_to_networkx_graph(ast.parse(code2))
    ...
    print("min(resG1, resG2):{}".format(min(resG1.number_of_nodes(), resG2.number_of_nodes())))
