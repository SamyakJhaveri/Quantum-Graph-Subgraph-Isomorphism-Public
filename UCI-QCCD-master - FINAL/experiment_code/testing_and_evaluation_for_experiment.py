...
def get_current_solution_sampleset_evaluation_data(sampleset):
    ...
    """ Not Supported by Hybrid Solvers as of October 2023 (when this paper was published)
...
def get_solver_sampler_information(sampler):
    ...
    # Category
    print(
        "Category ['qpu', 'hybrid', 'software']: {}".format(
    ...
    print(
        "Maximum number of biases, both linear and quadratic in total, accepted by the solver: {}".format(
    ...
    print(
        "Maximum number of problem variables accepted by the solver: {}".format(
    ...
    print(
        "Maximum allowed run Time in Hours that can be specified for the solver: {}".format(
    ...
    # Minimum Time Limit
    print(
        "Minimum required run time, in seconds, the solver must be allowed to work on the given problem."
