...
if __name__ == "__main__":
    ...
    G1_file_url = '/home/samyaknj/Research/UCI Quantum Code Clone Detection Project/Dataset/sample1/sample1_type2_v1.py'#os.path.join(args.folder, 'test_graph_code.py')
    ...
    G2_file_url = '/home/samyaknj/Research/UCI Quantum Code Clone Detection Project/Dataset/sample1/sample1_type3_v1.py'# os.path.join(args.folder, 'test_subgraph_code.py')    
